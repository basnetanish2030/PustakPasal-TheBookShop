...
<body>
    ...
    <div class="item_row">
        <div class="title-box">
            ...
            <a href="#"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php

            $sql = "SELECT * FROM rental_entry LIMIT 15";
            ...
            if(mysqli_num_rows($run) > 0){
                while ($items = mysqli_fetch_assoc($run)) {
                    ...
                    echo "<a href='product.php?rental_id=$id'><li class='item'>
    ...
    <div class="item_row">
        ...
        $sql = "SELECT * FROM rental_entry WHERE category='Course Book' LIMIT 15";
        $run = mysqli_query($conn, $sql);
        if(mysqli_num_rows($run) > 0){
            while ($items = mysqli_fetch_assoc($run)) {
                $id = $items['id'];
    ...
    <div class="item_row">
        ...
        $sql = "SELECT * FROM rental_entry WHERE category='Poetry' LIMIT 15";
        $run = mysqli_query($conn, $sql);
        if(mysqli_num_rows($run) > 0){
            while ($items = mysqli_fetch_assoc($run)) {
                $id = $items['id'];
...
?>
    ...
    <div class="title-box">
        ...
        $sql = "SELECT * FROM rental_entry WHERE category='Biography' LIMIT 15";
        $run = mysqli_query($conn, $sql);
        if(mysqli_num_rows($run) > 0){
            while ($items = mysqli_fetch_assoc($run)) {
                $id = $items['id'];
...
?>
    ...
    <div class="title-box">
        ...
        $sql = "SELECT * FROM rental_entry WHERE category='Fiction' LIMIT 15";
        $run = mysqli_query($conn, $sql);
        if(mysqli_num_rows($run) > 0){
            while ($items = mysqli_fetch_assoc($run)) {
                $id = $items['id'];
