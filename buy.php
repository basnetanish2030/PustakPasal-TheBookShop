...
<body>
    ...
    <div class="item_row">
        <div class="title-box">
            ...
            <a href="recent.php"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php
                ...
                echo "<h1 align='center' class='grey'>No books found!</h1>";
            }
    ...
    <div class="item_row">
        <div class="title-box">
            <h3>Course Books</h3>
            <a href="course.php"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php
            $sql = "SELECT * FROM book_entry WHERE category='Course Book' LIMIT 15";
            $run = mysqli_query($conn, $sql);
            if(mysqli_num_rows($run) > 0){
                while ($items = mysqli_fetch_assoc($run)) {
                    $id = $items['id'];
    ...
    <div class="item_row">
        <div class="title-box">
            <h3>Poetry</h3>
            <a href="poetry.php"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php
            $sql = "SELECT * FROM book_entry WHERE category='Poetry' LIMIT 15";
            $run = mysqli_query($conn, $sql);
            if(mysqli_num_rows($run) > 0){
                while ($items = mysqli_fetch_assoc($run)) {
                    $id = $items['id'];
    ...
    <div class="title-box">
            <h3>Biography</h3>
            <a href="biography.php"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php
            $sql = "SELECT * FROM book_entry WHERE category='Biography' LIMIT 15";
            $run = mysqli_query($conn, $sql);
            if(mysqli_num_rows($run) > 0){
                while ($items = mysqli_fetch_assoc($run)) {
                    $id = $items['id'];
    ...
    <div class="title-box">
            <h3>Fiction</h3>
            <a href="fiction.php"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php
            $sql = "SELECT * FROM book_entry WHERE category='Fiction' LIMIT 15";
            $run = mysqli_query($conn, $sql);
            if(mysqli_num_rows($run) > 0){
                while ($items = mysqli_fetch_assoc($run)) {
                    $id = $items['id'];
    ...
    <div class="title-box">
            <h3>Drama</h3>
            <a href="drama.php"><h5>See More..</h5></a>
        </div>
        <ul class="item_list">
        <?php
            $sql = "SELECT * FROM book_entry WHERE category='Drama' LIMIT 15";
            $run = mysqli_query($conn, $sql);
            if(mysqli_num_rows($run) > 0){
                while ($items = mysqli_fetch_assoc($run)) {
                    $id = $items['id'];
